...
function Topbar() {
    ...
    return (
        <>
            <div className="first-div flex gap-6 min-w-full items-center p-4">
                <div className="bg-white/50 flex gap-2 border border-white/80 rounded-full px-2 items-center flex-1">
                    <FaSearch />
