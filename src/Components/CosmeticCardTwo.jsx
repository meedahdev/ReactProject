...
function CosmeticCardTwo ({ cosmetic }) {
    ...
    return (
        <>
            <div className="p-4 flex border border-[orange]/50 bg-[orange]/20 rounded-md gap-6">
                ...
                <div className="p-2 space-y-2">
                    ...
                    <button onClick={() => addToCart(food)} className="text-white rounded py-1 px-4 bg-[#FF6B35]">Add to Cart</button>
                </div>
            </div>
        </>
    )
